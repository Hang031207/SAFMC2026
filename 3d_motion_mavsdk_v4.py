# Built on 3d_line_mavsdk_v3.py, but modified the part on mission 6 onwards
# In 3d_line_mavsdk_v3.py, mission 6 causes follower 1 to stuck at the gate when doing maneuver
...
async def leader_behavior(leader,target_heading):
    ...
    # Start mission 8: Align to end gate
    print("\n<-- Start mission 8, align to end gate -->\n"
