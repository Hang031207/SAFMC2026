...
# Based on v5, incorporate adaptive gain mechanism
# The gains within APF parameters gets tuned based on the magnitude of deviation from the desired formation distance
# Also, this version set the D_FORMATON to 1m, which is same as that of line formation during competition, see how it goes
...
async def drone1_behavior(drone1):
    ...
    end_heading1 = await straight_maneuver(drone1, hover_pos[0], hover_pos[1], hover_pos[2], current_heading, wp1_local_n, wp1_local_e, hover_pos[2], 2.0, 0.8)
    ...
    end_heading2 = await straight_maneuver(drone1, wp1_local_n, wp1_local_e, hover_pos[2], end_heading1, wp2_local_n, wp2_local_e, hover_pos[2], 2.0, 0.8)
