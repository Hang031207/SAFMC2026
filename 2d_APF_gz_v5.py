...
# Based on v4, incorporate velocity-matching algorithm, and predictive algorithm
# Velocity matching algorithm is to add a force that tries to match the velocity between drone2 and drone1
...
P                  = 10   # A constant to scale the effect of desired velocity on the real set_position function
